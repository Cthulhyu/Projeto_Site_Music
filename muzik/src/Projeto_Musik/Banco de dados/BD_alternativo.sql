...
-- -----------------------------------------------------
CREATE TABLE
  IF NOT EXISTS `sitemusica`.`Usuario` (
...
-- -----------------------------------------------------
CREATE TABLE
  IF NOT EXISTS `sitemusica`.`amigos` (
    `Usuario_idUsuario` INT NOT NULL,
    `idAmigo` INT NOT NULL,
    `status` VARCHAR(45) NULL,
    `data_inicio` INT NULL,
    PRIMARY KEY (`Usuario_idUsuario`, `idAmigo`),
    CONSTRAINT `fk_amigos_Usuario` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `sitemusica`.`Usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
  ) ENGINE = InnoDB;